...
export function Dashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h2 className="text-xl font-bold text-zinc-900 dark:text-white mb-4">Study Tip of the Day</h2>
        <p className="text-lg text-zinc-600 dark:text-zinc-300">
          "Break your study sessions into 25-minute intervals with 5-minute breaks to maintain peak concentration."
        </p>
      </motion.div>
    </div>
  );
